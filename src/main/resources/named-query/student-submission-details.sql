-- Same as student-tasklist-expand, however returns just 1 entry and includes the task description and
-- data from the task list.
-- This will return phantom submission information for submissions that do not exist in the database yet
-- Arguments
-- author_id - author id of the user the list is for (currently authenticated user)
-- task_id - the task to display
-- Returns
-- task_id, task_file_name, task_name, description, content_type, review_template_id, last_edited, submitted,
-- submission_file_name, grade, task_list_name, review_deadline, start_date, state, task_list_state, submission_deadline,
-- submission_audience, author_id, author_name
