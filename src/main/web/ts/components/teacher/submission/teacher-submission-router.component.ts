...
@RouteConfig([
    new AsyncRoute({
        path: '/:tid/:aid',
        loader: () => System.import(GrouftyHTTPService.getJS() + '/components/teacher/submission/teacher-submission-detail.component')
            .then(m => m.TeacherSubmissionDetailComponent),
        name: 'TeacherSubmissionDetail'
    })
])
export class TeacherSubmissionRouterComponent { }