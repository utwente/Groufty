...
@RouteConfig([
    new AsyncRoute({
        path: '/:id',
        loader: () => System.import(GrouftyHTTPService.getJS() + '/components/teacher/submission-lists/teacher-submission-lists-overview.component')
            .then(m => m.TeacherSubmissionListsOverviewComponent),
        name: 'TeacherSubmissionListsOverview'
    })
])
export class TeacherSubmissionListsRouterComponent { }