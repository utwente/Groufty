...
@RouteConfig([
    new AsyncRoute({
        path: '/',
        loader: () => System.import(GrouftyHTTPService.getJS() + '/components/teacher/task-lists/teacher-task-lists-overview.component')
            .then(m => m.TeacherTaskListsOverviewComponent),
        name: 'TeacherTaskListsOverview',
        useAsDefault: true
    })
])
export class TeacherTaskListsRouterComponent { }